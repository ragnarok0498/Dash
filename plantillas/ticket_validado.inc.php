<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control " name="tipoe" placeholder="Computacion, audio, video, impresoras etc." <?php $validador->mostrar_equipo_ticket() ?>>
            <?php
            $validador->mostrar_error_equipo_ticket();
            ?>
        </div>
    </div>
    <div class="col-md-8">
        <div class="form-group">
            ...
            <textarea name="descrip" class="form-control" maxlength="200" id="areadescripcion" cols="50" rows="6" placeholder="Especifique en un maximo de 200 caracteres cual es el fallo del dispositivo" <?php $validador->mostrar_descripcion_ticket() ?>></textarea>
            <?php
            $validador->mostrar_error_descripcion_ticket();
            ?>
        </div>
    </div>
